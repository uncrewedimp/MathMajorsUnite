"""
Django settings for cs340_project project.
...
SECRET_KEY = 'f84n)4=evd#s(t2#_h&ob@6axu1d6-0^9)xk6d!(d*3vv=6$cl'
...
ROOT_URLCONF = 'cs340_project.urls'
...
WSGI_APPLICATION = 'cs340_project.wsgi.application'
